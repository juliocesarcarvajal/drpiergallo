...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#adadb3'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '57px', 'lineheight' => '48px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#00838f'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#00bcd4'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#adadb3'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '29px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#00bcd4'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '63px', 'lineheight' => '63px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '24px', 'lineheight' => '30px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
